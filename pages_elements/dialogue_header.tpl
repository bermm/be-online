...
<head>
    ...
    <link rel="stylesheet" href="{url}/styles/menu.css" />
    <link rel="stylesheet" href="{url}/styles/search.css" />
	<link rel="stylesheet" href="{url}/styles/dialogue.css" />
...
<body>
    ...
    <div id="search_hover"></div>
        ...
        <audio id="player" controls>
       		<source src="../media/sound.mp3" type='audio/mpeg; codecs="mp3"'>
       	</audio>